...
class SimulatedAnnealing(Algorithm):
    ...
    def __init__(self, *,
        ...
        super().__init__()
        assert cooling_schedule in ["linear", "geometric", "logarithmic"], \
            "Cooling schedule must be either 'linear', 'geometric', or 'logarithmic'."
        self._initial_temperature: float = initial_temperature
        self._cooling_schedule: str = cooling_schedule
    ...
    def optimize(self,
        ...
        raise NotImplementedError("Simulated Annealing algorithm is not yet implemented.")
